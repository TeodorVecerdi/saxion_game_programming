...
namespace GXPEngine
{
	...
	public class Game : GameObject
	{
		...
		/// </param>
		public Game (int pWidth, int pHeight, bool pFullScreen, bool pVSync = true, int pRealWidth=-1, int pRealHeight=-1, bool pPixelArt=false, string windowTitle="Game") : base()
		{
			if (pRealWidth <= 0) {
				pRealWidth = pWidth;
			}
